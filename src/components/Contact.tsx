      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            <span className="text-amber-400">Вопросы?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-8 border border-slate-700/30">
            ...
            <p className="text-slate-300 mb-8">
              Присоединяйтесь к нашему чату в Telegram, чтобы следить за новостями и задавать вопросы организаторам напрямую. 
          ...
          <div className="flex flex-col space-y-8">
            <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/20">
              <h4 className="font-semibold mb-3 text-amber-400">Место проведения</h4>
              <p className="text-slate-300">Алматы, Казахстан</p>
              <p className="text-slate-300">Место проведения будет объявлено позже</p>
            </div>
            
            <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/20">
              <h4 className="font-semibold mb-3 text-amber-400">Даты</h4>
              <p className="text-slate-300">Август 2025</p>
              <p className="text-slate-300">9:00 - 22:00 (местное время)</p>
            </div>
            
            <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/20">
              <h4 className="font-semibold mb-3 text-amber-400">Email</h4>
              <p className="text-slate-300">contact@hackload.kz</p>
            </div>
          </div>
        </div>
      </div>
