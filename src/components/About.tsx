      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            Что такое <span className="text-green-400">HackLoad</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 gap-6">
            {organizerQuotes.map((quote, index) => (
              <div 
                key={index}
                className="bg-indigo-900/50 backdrop-blur-sm p-6 rounded-lg border border-indigo-700/50"
              >
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-mono text-gray-300">"{quote.quote}"</p>
                    <p className="mt-2 text-sm text-green-400">{quote.author}</p>
                  </div>
                </div>
              </div>
            ))}
