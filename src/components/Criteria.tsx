      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            How <span className="text-green-400">Winners</span> Are Determined
          </h2>
        ...
        <div className="mt-16 p-6 bg-indigo-900/30 backdrop-blur-sm rounded-lg border border-indigo-700/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-green-400 mb-2">Automated Testing</h4>
              <p className="text-gray-300 text-sm">Systems undergo automated load tests to measure performance metrics objectively.</p>
            </div>
            <div className="text-center">
              <div className="h-12 w-12 rounded-full bg-green-400/10 flex items-center justify-center mx-auto mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h4 className="font-semibold text-green-400 mb-2">Expert Review</h4>
              <p className="text-gray-300 text-sm">Industry experts review code quality, architecture, and innovative approaches.</p>
            </div>
            <div className="text-center">
              <div className="h-12 w-12 rounded-full bg-green-400/10 flex items-center justify-center mx-auto mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h4 className="font-semibold text-green-400 mb-2">Solution Presentation</h4>
              <p className="text-gray-300 text-sm">Teams present their approach, architecture decisions, and lessons learned.</p>
            </div>
          </div>
        </div>
      </div>
