      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            Наши <span className="text-green-400">Ценности</span>
          </h2>
          ...
          {principles.map((principle, index) => {
            ...
            return (
              <div
                key={index}
                ref={elementRef}
                className={`bg-indigo-900/50 backdrop-blur-sm rounded-lg p-6 border border-indigo-700/30 flex flex-col items-center text-center ${scaleInAnimation(isVisible)}`}
                style={{ transition: 'all 0.5s cubic-bezier(0.16, 1, 0.3, 1)', transitionDelay: `${index * 100}ms` }}
              >
                <div className="h-16 w-16 rounded-full bg-green-400/10 flex items-center justify-center mb-4">
        ...
        <div className="mt-16 text-center">
          <div className="bg-indigo-900/30 backdrop-blur-sm rounded-lg p-6 inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-green-400 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              В HackLoad мы верим в создание возможностей для разработчиков решать реальные задачи
              в совместной, образовательной среде. Наше мероприятие направлено на развитие как навыков, так и сообщества.
            </p>
          </div>
        </div>
      </div>
